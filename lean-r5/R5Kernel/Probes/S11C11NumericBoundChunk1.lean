...
theorem kernel_c11_canonical_scaled_bound_chunk1 : ∀ i : Fin 32,
    r5RepNatScaledValue11C11
        (kernelC11Row (kernelC11CanonicalRep126
          ⟨i.val + 32, by omega⟩).val) ≤ 206 := by
  decide +kernel

run_cmd R5Kernel.checkStandardAxioms ``kernel_c11_canonical_scaled_bound_chunk1
